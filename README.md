...
```bash
https://github.com/dhavalantala/chicken_diseases_classification.git
```
### STEP 01- Create a conda environment after opening the repository

```bash
conda create -p chickenvenv python=3.10 -y
```

```bash
conda activate chickenvenv/
```
...
## 3. Create ECR repo to store/save docker image
    - Save the URI: 643905067493.dkr.ecr.eu-central-1.amazonaws.com/chicken
